...
echo ""
echo -e "${GREEN}for shipping copy the target Folder to the client-server and start the docker-compose file"
echo ""
echo "target dir: $TARGETDIR"
echo ""
echo "start docker with: docker-compose -p <stack-name> up -d"